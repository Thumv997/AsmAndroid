    ...
    public void showAlertDialog(final int key_id, final ClassDAO classDAO){
        ...
        builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                refresh(classDAO);
                Toast.makeText(List_Class.this, "Da Xoa Thanh Cong", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnSaveForm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(keyClass)){
                    Toast.makeText(List_Class.this, "Ma Lop Khong Duoc ROng", Toast.LENGTH_SHORT).show();
                    dialog.setCancelable(true);
                }else if (TextUtils.isEmpty(NameClass)){
                    Toast.makeText(List_Class.this, "Ten Lop Khong Duoc Rong ", Toast.LENGTH_SHORT).show();
                    dialog.setCancelable(true);
                }else {
