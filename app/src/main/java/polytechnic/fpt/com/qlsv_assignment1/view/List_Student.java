...
import polytechnic.fpt.com.qlsv_assignment1.adapter.CustomAdapter;
import polytechnic.fpt.com.qlsv_assignment1.adapter.CustomAdapterForStudent;
import polytechnic.fpt.com.qlsv_assignment1.data.ClassDAO;
import polytechnic.fpt.com.qlsv_assignment1.data.DbHelper;
import polytechnic.fpt.com.qlsv_assignment1.data.StudentDAO;
...
public class List_Student extends AppCompatActivity {
    ...
    public void showAlertDialog(final StudentDAO studentDAO, final int key_id, final int key_Class, final List<String> list){
        ...
        builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                refresh(studentDAO);
                Toast.makeText(List_Student.this, "Da Xoa Thanh Cong", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnSaveForm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(keyClass)){
                    Toast.makeText(List_Student.this, "Ma Lop Khong Duoc ROng", Toast.LENGTH_SHORT).show();
                    dialog.setCancelable(true);
                }else if (TextUtils.isEmpty(NameClass)){
                    Toast.makeText(List_Student.this, "Ten Lop Khong Duoc Rong ", Toast.LENGTH_SHORT).show();
                    dialog.setCancelable(true);
                }else {
    ...
    public Student createStudent(){
        ...
        if (TextUtils.isEmpty(name)){
            Toast.makeText(List_Student.this, "Ten SV Khong Duoc De Trong", Toast.LENGTH_SHORT).show();
        }else if (TextUtils.isEmpty(birthday)){
            Toast.makeText(List_Student.this, "Ngay Sinh Khong Duoc De Trong", Toast.LENGTH_SHORT).show();
        }else {
