         ...
         btnSaveForm.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 ...
                 if (TextUtils.isEmpty(keyClass)){
                     Toast.makeText(MainActivity.this, "Ma Lop Khong Duoc ROng", Toast.LENGTH_SHORT).show();
                     dialog.setCancelable(true);
                 }else if (TextUtils.isEmpty(NameClass)){
                     Toast.makeText(MainActivity.this, "Ten Lop Khong Duoc Rong ", Toast.LENGTH_SHORT).show();
                     dialog.setCancelable(true);
                 }else {
                     Class_model classModel = new Class_model(keyClass,NameClass);
                     classDAO.addClass(classModel);
                     Toast.makeText(MainActivity.this, "Tao Class Thanh Cong", Toast.LENGTH_SHORT).show();
                     dialog.dismiss();
                 }
             }
         });
